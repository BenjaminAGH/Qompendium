          ...
          items: [
            { label: 'Presentación del Apartado', slug: 'cursos/example' },
            {
              ...
              items: [
                ...
                { label: 'Análisis de Red', slug: 'cursos/crc/analisisred', badge: { text: 'Certamen', variant: 'success' } },
                {
                  ...
                  items: [
                    ...
                    { label: 'Protocolo DNS', slug: 'cursos/crc/aplicacion/dns' },
                    { label: 'Protocolo HTTP', slug: 'cursos/crc/aplicacion/http' },
